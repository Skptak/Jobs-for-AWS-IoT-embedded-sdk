...
# Macro utility to add library targets for Unity and CMock to build
# configuration.
macro(add_cmock_targets)
  # Build Configuration for CMock and Unity libraries.
  list(APPEND CMOCK_INCLUDE_DIRS "${CMOCK_DIR}/vendor/unity/src/"
       "${CMOCK_DIR}/vendor/unity/extras/fixture/src"
       "${CMOCK_DIR}/vendor/unity/extras/memory/src" "${CMOCK_DIR}/src")
  ...
  target_include_directories(unity PUBLIC ${CMOCK_INCLUDE_DIRS})
